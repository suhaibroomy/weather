...
//    @Test
//    fun saveNewCityTest() {
//        val city = CityEntity("abcd", "efgh", 1246)
...
//    @Test
//    fun saveNewFailTest() {
//        val city = CityEntity("abcd", "efgh", 0)
//        val cityWeatherEntity = CityWeatherEntity(city.id, WeatherModel(), city = city)
//        // Add city to existing list
//        cityWeatherList.add(cityWeatherEntity)
//        viewModel.cityListLiveData.value?.add(cityWeatherEntity)
//        viewModel.saveNewCity(city)
//
...
//        Mockito.verify(cityWeatherRepository).fetchWeatherWithLatLong(location.latitude, location.longitude)
//    }
//
//    @Test
